...
<div class="wrapper">
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown messages-menu">
            ...
            <ul class="dropdown-menu">
              <li class="header">Voir  les messages recent</li>
              <li>
          ...
          <li class="dropdown notifications-menu">
            ...
            <ul class="dropdown-menu">
              <li class="header">Vous avez # notifications</li>
              <li>
                <!-- inner menu: contains the actual data -->
                <ul class="menu">
          ...
          <li class="dropdown tasks-menu">
            ...
            <ul class="dropdown-menu">
              <li class="header">Vous avez # questions</li>
              <li>
                <!-- inner menu: contains the actual data -->
                <ul class="menu">
                  <li><!-- Task item -->
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="ConsulterListeDemande"><i class="fa fa-circle-o"></i> Consulter liste Demandes</a></li>
  ...
  <footer class="main-footer">
    ...
    <strong>Nejma <a href="http://almsaeedstudio.com"></a>.</strong> All rights
    reserved.
  </footer>
