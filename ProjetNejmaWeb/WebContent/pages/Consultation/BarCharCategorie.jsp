 ...
 <%@page language="java" import="entityBeans.*,java.util.Collections,java.util.Comparator,java.util.ArrayList,java.util.Iterator,java.text.SimpleDateFormat,java.util.Collection" import="java.util.List" %>
...
anychart.onDocumentReady(function () {
    ...
    var dataSet = anychart.data.set([
    	<%
        ArrayList<Categorie> cc =(ArrayList<Categorie>)request.getAttribute("cc");
if (cc != null) {
	
	for (int i = 0; i < cc.size(); i++) 
	{      			
 %>
 [<%out.print("'"+cc.get(i).getNom()+"'");%>,
<% 



		List<Produit>pp=cc.get(i).getProduits();
		Collections.sort(pp, new Comparator<Produit>(){
		    public int compare(Produit s1, Produit s2) {
		        return Double.valueOf(s1.getPrix()).compareTo(Double.valueOf(s2.getPrix()));
		    }
...
<%}} %>
    ...
    var seriesData_4 = dataSet.mapAs({x: [0], value: [5]});
    var seriesData_4 = dataSet.mapAs({x: [0], value: [6]});
    ...
    chart.title('Statestique des categories par prix produit');
    ...
    chart.yAxis().title('Revenue in Dinar tunisien');
