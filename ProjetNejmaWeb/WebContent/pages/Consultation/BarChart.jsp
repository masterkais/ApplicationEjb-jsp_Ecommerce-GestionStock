...
anychart.onDocumentReady(function () {
    ...
    var dataSet = anychart.data.set([
    	...
    	<%
        ArrayList<Commande> j0 =(ArrayList<Commande>)request.getAttribute("j0");
    ArrayList<Commande> j1 =(ArrayList<Commande>)request.getAttribute("j1");
    ArrayList<Commande> j2 =(ArrayList<Commande>)request.getAttribute("j2");
    ArrayList<Commande> j3 =(ArrayList<Commande>)request.getAttribute("j3");
       %>
    ['',<%if(j0.size()>0) {out.print(j0.get(0).getMtFinal());}else{out.print(",");}%>,<%if(j1.size()>0) {out.print(j1.get(0).getMtFinal());}else{out.print(",");}%>,<%if(j2.size()>0) {out.print(j2.get(0).getMtFinal());}else{out.print(",");}%>,<%if(j3.size()>0) {out.print(j3.get(0).getMtFinal());}else{out.print(",");}%>],   	
    [' ',<%if(j0.size()>1) {out.print(j0.get(1).getMtFinal());}else{out.print(",");}%>,<%if(j1.size()>1) {out.print(j1.get(1).getMtFinal());}else{out.print(",");}%>,<%if(j2.size()>1) {out.print(j2.get(1).getMtFinal());}else{out.print(",");}%>,<%if(j3.size()>1) {out.print(j3.get(1).getMtFinal());}else{out.print(",");}%>],  
    ['    ',<%if(j0.size()>2) {out.print(j0.get(2).getMtFinal());}else{out.print(",");}%>,<%if(j1.size()>2) {out.print(j1.get(2).getMtFinal());}else{out.print(",");}%>,<%if(j2.size()>2) {out.print(j2.get(2).getMtFinal());}else{out.print(",");}%>,<%if(j3.size()>2) {out.print(j3.get(2).getMtFinal());}else{out.print(",");}%>],
    ['  ',<%if(j0.size()>3) {out.print(j0.get(3).getMtFinal());}else{out.print(",");}%>,<%if(j1.size()>3) {out.print(j1.get(3).getMtFinal());}else{out.print(",");}%>,<%if(j2.size()>3) {out.print(j2.get(3).getMtFinal());}else{out.print(",");}%>,<%if(j3.size()>3) {out.print(j3.get(3).getMtFinal());}else{out.print(",");}%>],
     ]);
    ...
    chart.title('apport quotidien dans 3 jours');
    ...
    setupSeriesLabels(series, 'Ajourdhui');

    // create second series with mapped data
    series = chart.column(seriesData_2);
    setupSeriesLabels(series, 'Hier');

    // create third series with mapped data
    series = chart.column(seriesData_3);
    setupSeriesLabels(series, 'Avant hier');

    // create fourth series with mapped data
    series = chart.column(seriesData_4);
    setupSeriesLabels(series, 'avant 2 jours');
