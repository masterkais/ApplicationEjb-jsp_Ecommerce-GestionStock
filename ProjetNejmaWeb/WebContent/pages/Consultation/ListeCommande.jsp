            ...
            <div class="box-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                          ...
                          <th>Numero commande</th>
                           <th class="select-filter">Paiement</th>
                          <th>Client</th>
                          <th>Date commande</th>
                          <th>Date Livrason</th>
...
<%
ArrayList<Commande> commandes =(ArrayList<Commande>)request.getAttribute("listcom");
			if (commandes != null) {
				...
				for (int i = 0; i < commandes.size(); i++) 
				{
					...
					out.println("<td> " + commandes.get(i).getId()+ "</td>");
						...
						out.println("<td> " + commandes.get(i).getUtilisateur().getCin()+ "</td>");
					out.println("<td> " + commandes.get(i).getDate_commande() + "</td>");
					if(commandes.get(i).getDate_livraison() ==null){out.println("<td> </td>");}else{	out.println("<td> " + commandes.get(i).getDate_livraison() + "</td>");}
					
					
                    if(commandes.get(i).getValide()==1){		
                    	out.println("<td> <span class='primary'>Non Facturer</span></td>");
					out.print("<td>  <a class='btn btn-warning btn-sm' href ='Facturer?id="+ commandes.get(i).getId()+"'><span class='glyphicon glyphicon-ok'></span>  Facturer</a>");
  ...
  <span class="glyphicon glyphicon-eye-open"></span>  View 
					  	...
					  	out.println("<td> <span class='primary'>Deja facturé </span></td>");
						out.print("<td>  <a class='btn btn-warning btn-sm' target='_blank' href ='Facture?id="+ commandes.get(i).getId()+"'><span class='glyphicon glyphicon-paste'></span> Facture</a> ");
						%>   <a target="_blank" href="ViewProduitCommande?id=<%out.print(commandes.get(i).getId()); %>" class="btn btn-primary pull-right"  >
						  <span class="glyphicon glyphicon-eye-open"></span>  View
						</a></td><% 	 	 
					}  
				else if(commandes.get(i).getValide()==4){
				  	out.println("<td> <span class='primary'>Rejeter </span></td>");
					out.print("<td>");
					%>   <a target="_blank" href="ViewProduitCommande?id=<%out.print(commandes.get(i).getId()); %>" class="btn btn-primary pull-right"  >
					  <span class="glyphicon glyphicon-eye-open"></span>  View
					</a></td><% 	 	 
				}
				else if(commandes.get(i).getValide()==0 && commandes.get(i).getTypepaaiment()==1){  out.println("<td> <span class='primary'>En attente </span></td>");
				out.print("<td>  <a class='btn btn-warning btn-sm' href ='AccepterCommande?idcomm="+ commandes.get(i).getId()+"'><span class='glyphicon glyphicon-ok'></span>  Accepter </a>  <a class='btn btn-danger btn-sm' href ='RefuserCommande?idrc="+ commandes.get(i).getId()+"'><span class='glyphicon glyphicon-trash'></span>  Refuser </a>");
				%>   <a target="_blank" href="ViewProduitCommande?id=<%out.print(commandes.get(i).getId()); %>" class="btn btn-primary pull-right"  >
				  <span class="glyphicon glyphicon-eye-open"></span>  View
				</a>
				 <a target="_blank" href="https://www.paypal.com/myaccount/home" class="btn btn-info pull-right"  >
				  <span class="glyphicon glyphicon-usd"></span>paypal
				</a>
				</td>
					<% }else{  out.println("<td> <span class='primary'>En attente </span></td>");
					out.print("<td>  <a class='btn btn-warning btn-sm' href ='AccepterCommande?idcomm="+ commandes.get(i).getId()+"'><span class='glyphicon glyphicon-ok'></span>  Accepter Commande</a>  <a class='btn btn-danger btn-sm' href ='RefuserCommande?idrc="+ commandes.get(i).getId()+"'><span class='glyphicon glyphicon-trash'></span>  Refuser Commande</a>");
					%>   <a target="_blank" href="ViewProduitCommande?id=<%out.print(commandes.get(i).getId()); %>" class="btn btn-primary pull-right"  >
					  <span class="glyphicon glyphicon-eye-open"></span>  View
					</a></td><% }
					out.println("</tr>");
