          ...
          <div class="box">
            <div class="box-header">
              <center><h3 class="box-title">Mon liste de produit favorie</h3></center>
                <ol class="breadcrumb">
                 <a type="button" href="ViderListeFavorie1" class="btn btn-success btn-lg btn3d"><span class="glyphicon glyphicon-folder-close"></span> Vider la liste</a>
...
Panier prods =(Panier)session.getAttribute("favorie");
			if (prods != null) {
				...
				for (int i = 0; i < prods.getProduits().size(); i++) 
				{
					...
					<%
					out.println(" <a class='btn btn-danger btn-sm'  href ='SupprimerProduitFavorie1?id="+((Produit) prods.getProduits().get(i)).getId()+"'  onclick='return confirm(\"Voulez vous vraiment supprimer ce produit ?\")'      ><span class='glyphicon glyphicon-trash'></span>  Supprimer produit</a> </td>");
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form method="post" action="AjouterProduitFavorieAuPanier1">
