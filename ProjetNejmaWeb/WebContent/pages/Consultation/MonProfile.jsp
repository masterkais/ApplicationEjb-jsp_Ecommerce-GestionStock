...
ArrayList<Message> msg =(ArrayList<Message>)request.getAttribute("ListMessageRecent");
  ...
  <div class="content-wrapper">
       ...
       <!-- model 2 -->
<center><h4  id="myModalLabel">Mon Profil Utilisateur </h4></center>
      </div>
      
         
<form  action="ModifierProfile" method="post"  ng-submit="ctrl.submit()" name="userForm" >
...
SimpleDateFormat dff=new SimpleDateFormat("yyyy-MM-dd");
					...
					out.println("<td> " + dff.format(((Message)messages.get(i)).getDate())+ "</td>");
