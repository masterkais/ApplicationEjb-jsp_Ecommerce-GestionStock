...
anychart.onDocumentReady(function () {
    var data = [
    	<%
    	        ArrayList<Produit> pp =(ArrayList<Produit>)request.getAttribute("listp");
    	if (pp != null) {
			
			for (int i = 0; i < pp.size(); i++) 
			{      			
    	 %>
    	 {x: <%out.print("'"+pp.get(0).getNom()+"'");%>, value: <%out.print(pp.get(0).getQuantite());%>},       
        {x: <%out.print("'"+pp.get(1).getNom()+"'");%>, value: <%out.print(pp.get(1).getQuantite());%>},
        {x: <%out.print("'"+pp.get(2).getNom()+"'");%>, value: <%out.print(pp.get(2).getQuantite());%>},
        {x: <%out.print("'"+pp.get(3).getNom()+"'");%>, value: <%out.print(pp.get(3).getQuantite());%>},
        {x: <%out.print("'"+pp.get(4).getNom()+"'");%>, value: <%out.print(pp.get(4).getQuantite());%>},
        {x: <%out.print("'"+pp.get(5).getNom()+"'");%>, value: <%out.print(pp.get(5).getQuantite());%>},
        {x: <%out.print("'"+pp.get(6).getNom()+"'");%>, value: <%out.print(pp.get(6).getQuantite());%>},
        {x: <%out.print("'"+pp.get(7).getNom()+"'");%>, value: <%out.print(pp.get(7).getQuantite());%>},
   ...
   <%}} %>
    ...
    chart.title('Pareto Chart pour la liste des produits');
    ...
    column.labels().enabled(true).textFormatter('{%RF}%');
    column.tooltip().textFormatter("Value: {%Value}");

    // get pareto line series and set settings
    var line = chart.getSeriesAt(1);
    line.tooltip().textFormatter("Cumulative Frequency: {%CF}% \n Relative Frequency: {%RF}%");

    // create first horizontal line marker
    var lineMarkerFirst = chart.lineMarker(0);
    lineMarkerFirst.axis(chart.yAxis(1));
    lineMarkerFirst.value(10);
    lineMarkerFirst.stroke("#A5B3B3", 1, "10 2", "round"); // sets stroke

    // create second horizontal line marker
    var lineMarkerSecond = chart.lineMarker(1);
    lineMarkerSecond.axis(chart.yAxis(1));
    lineMarkerSecond.value(60);
    lineMarkerSecond.stroke("#A5B3B3", 1, "10 2", "round"); // sets stroke
