...
anychart.onDocumentReady(function () {
    ...
    chart = anychart.pie([
        ...
        <%
        ArrayList<Categorie> mess =(ArrayList<Categorie>)request.getAttribute("listcat");
        			if (mess != null) {
        			
        				for (int i = 0; i < mess.size(); i++) 
        				{%>
        				["<%out.print(mess.get(i).getNom());%>", <%out.print(mess.get(i).getProduits().size());%>],
    ...
    chart.title('Statestique de stock par categorie');
