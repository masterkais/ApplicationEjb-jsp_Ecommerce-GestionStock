 ...
 */
@WebServlet("/AccepterCommande")
public class AccepterCommande extends HttpServlet {
	...
	String id=request.getParameter("idcomm");
		...
		gc.activerCommande( Integer.parseInt(id), 1);
		//String prenom=u.getPrenom();
		HttpSession session=request.getSession(true);
		session.setAttribute("notif", " vous avez accpté la commande numero :"+gc.getCommandeById(Integer.parseInt(id)).getId());	
