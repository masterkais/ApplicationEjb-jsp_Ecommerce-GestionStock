 ...
 */
@WebServlet("/AjouterPanier1")
public class AjouterPanier1 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			String idp=request.getParameter("idp1");
			String qte=request.getParameter("qtdis");
