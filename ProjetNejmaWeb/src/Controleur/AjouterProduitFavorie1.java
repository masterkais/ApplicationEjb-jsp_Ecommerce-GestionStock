 ...
 */
@WebServlet("/AjouterProduitFavorie1")
public class AjouterProduitFavorie1 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		session.setAttribute("notif", " vous avez ajouté un produit dans la liste favori");	
