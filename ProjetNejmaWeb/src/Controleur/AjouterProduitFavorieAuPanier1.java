...
/**
 * Servlet implementation class AjouterProduitFavorieAuPanier
 */
@WebServlet("/AjouterProduitFavorieAuPanier1")
public class AjouterProduitFavorieAuPanier1 extends HttpServlet {
     ...
     */
    public AjouterProduitFavorieAuPanier1() {
        super();
	...
	session.setAttribute("notif", " vous avez ajouté un produit dans le panier ");	
			...
			response.sendRedirect("ConsulterListeFavorie1");
		}catch(Exception er){
			er.printStackTrace();
		}
	}
