...
/**
 * Servlet implementation class ConsulterListeCategorie
 */
@WebServlet("/ConsulterListeCategorie")
public class ConsulterListeCategorie extends HttpServlet {
     ...
     */
    public ConsulterListeCategorie() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try{
			//	Context c=new InitialContext();
				...
				request.getRequestDispatcher("pages/Consultation/ListeCategorie.jsp").forward(request,response);
