 ...
 */
@WebServlet("/ConsulterListeCommande")
public class ConsulterListeCommande extends HttpServlet {
   ...
   InterfaceGestionUtilisateurRemote g;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("pages/Consultation/ListeCommande.jsp").forward(request, response);
