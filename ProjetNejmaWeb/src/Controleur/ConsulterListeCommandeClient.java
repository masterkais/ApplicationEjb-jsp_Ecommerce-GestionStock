 ...
 */
@WebServlet("/ConsulterListeCommandeClient")
public class ConsulterListeCommandeClient extends HttpServlet {
     ...
     */
    public ConsulterListeCommandeClient() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
            ...
            ArrayList<Commande> lc=gc.getC(u.getCin());
	...
	request.getRequestDispatcher("pages/Consultation/ListeCommandeClient.jsp").forward(request, response);
