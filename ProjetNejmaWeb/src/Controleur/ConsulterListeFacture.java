 ...
 */
@WebServlet("/ConsulterListeFacture")
public class ConsulterListeFacture extends HttpServlet {
   ...
   InterfaceGestionFactureRemote gf;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			System.out.println("kkkk"+lff.size());
		...
		request.getRequestDispatcher("pages/Consultation/ListeFacture.jsp").forward(request, response);
