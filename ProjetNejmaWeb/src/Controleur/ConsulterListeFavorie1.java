 ...
 */
@WebServlet("/ConsulterListeFavorie1")
public class ConsulterListeFavorie1 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("pages/Consultation/ListeProduitFavorie1.jsp").forward(request,response);
	}
