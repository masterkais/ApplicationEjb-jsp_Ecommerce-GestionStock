 ...
 */
@WebServlet("/ConsulterListePanier1")
public class ConsulterListePanier1 extends HttpServlet {
...
Panier pan=u.getPanier();
	...
	if(pp==null){ System.out.println("ando paanier liste ferga"); request.setAttribute("nbrPF", 0);}
		...
		request.getRequestDispatcher("pages/Consultation/Panier1.jsp").forward(request,response);
	}
