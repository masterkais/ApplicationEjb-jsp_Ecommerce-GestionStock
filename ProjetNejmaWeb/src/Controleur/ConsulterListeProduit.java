...
/**
 * Servlet implementation class ConsulterListeProduit
 */
@WebServlet("/ConsulterListeProduit")
public class ConsulterListeProduit extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			request.setAttribute("listmessage", lmm);
				request.getRequestDispatcher("pages/Consultation/ListeProduit.jsp").forward(request,response);
