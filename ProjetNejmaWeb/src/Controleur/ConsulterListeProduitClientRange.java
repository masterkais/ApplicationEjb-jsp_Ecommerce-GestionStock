 ...
 */
@WebServlet("/ConsulterListeProduitClientRange")
public class ConsulterListeProduitClientRange extends HttpServlet {
     ...
     */
    public ConsulterListeProduitClientRange() {
        super();
	...
	if(pp==null){ System.out.println("ando paanier liste ferga"); request.setAttribute("nbrPF", 0);}
		...
		System.out.println("ando paanier liste mailyena tayha"+pp.size()); request.setAttribute("nbrPF", pp.size());}
			...
			request.getRequestDispatcher("pages/Consultation/ListeProduitClientRange.jsp").forward(request,response);
