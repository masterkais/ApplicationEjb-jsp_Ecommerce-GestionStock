 ...
 */
@WebServlet("/ConsulterListeProduitPromotion")
public class ConsulterListeProduitPromotion extends HttpServlet {
     ...
     */
    public ConsulterListeProduitPromotion() {
        super();
	...
	if(pp==null){ System.out.println("ando paanier liste ferga"); request.setAttribute("nbrPF", 0);}
		...
		System.out.println("ando paanier liste mailyena tayha"+pp.size()); request.setAttribute("nbrPF", pp.size());}
			...
			request.getRequestDispatcher("pages/Consultation/ListeProduitClientPromotion.jsp").forward(request,response);
