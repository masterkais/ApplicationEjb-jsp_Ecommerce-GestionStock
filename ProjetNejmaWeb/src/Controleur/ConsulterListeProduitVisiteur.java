...
/**
 * Servlet implementation class ConsulterListeProduitVisiteur
 */
@WebServlet("/ConsulterListeProduitVisiteur")
public class ConsulterListeProduitVisiteur extends HttpServlet {
     ...
     */
    public ConsulterListeProduitVisiteur() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.setAttribute("listProduit", lp);
			...
			request.getRequestDispatcher("pages/Consultation/ProduitVisiteur.jsp").forward(request,response);
