...
/**
 * Servlet implementation class ConsulterListeProduitVisiteurPromotion
 */
@WebServlet("/ConsulterListeProduitVisiteurPromotion")
public class ConsulterListeProduitVisiteurPromotion extends HttpServlet {
     ...
     */
    public ConsulterListeProduitVisiteurPromotion() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Produit> lp=gp.getAllProduitsPromotion();
		request.setAttribute("listProduit", lp);
	
			request.getRequestDispatcher("pages/Consultation/ListeProduitPromotionVisiteur.jsp").forward(request,response);
