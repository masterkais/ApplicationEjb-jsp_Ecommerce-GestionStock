 ...
 */
@WebServlet("/ConsulterListePromotionClient")
public class ConsulterListePromotionClient extends HttpServlet {
     ...
     */
    public ConsulterListePromotionClient() {
        super();
	...
	if(pp==null){ System.out.println("ando paanier liste ferga"); request.setAttribute("nbrPF", 0);}
		...
		System.out.println("ando paanier liste mailyena tayha"+pp.size()); request.setAttribute("nbrPF", pp.size());}
			...
			request.getRequestDispatcher("pages/Consultation/ListePromotionClient.jsp").forward(request,response);
