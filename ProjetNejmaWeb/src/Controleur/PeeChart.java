...
/**
 * Servlet implementation class PeeChart
 */
@WebServlet("/PeeChart")
public class PeeChart extends HttpServlet {
	...
	try{
		...
		request.setAttribute("listmessage", lmm);
			...
			request.getRequestDispatcher("pages/Consultation/PeeChart.jsp").forward(request, response);
